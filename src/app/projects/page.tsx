...
function Page() {
  const FeaturedProject = ({
    ...
    return (
      <>
        <article className=" dark:bg-dark dark:text-light p-12 w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light dark:border-light shadow-solid-light">
          <Link
          ...
          <div className="w-1/2 flex flex-col items-start justify-between pl-6 ">
            ...
            <p className="my-2 dark:text-slate-400 !font-medium text-dark/80">
              {summary}
            </p>
            <div className="flex flex-row items-start">
              ...
              <Link
                className="dark:bg-light dark:text-dark rounded-lg ml-5 flex items-center justify-center w-40 h-10 bg-dark text-light "
                target="_blank"
                href={link}
              >
                Visit Project
      ...
      <>
        <article className="p-12 w-full flex flex-col items-center justify-between rounded-3xl  border border-solid border-dark bg-light dark:bg-dark shadow-solid dark:shadow-solid-light dark:border-light">
          ...
          <div className="w-full  flex flex-col items-start justify-between ">
            <span className="text-primary dark:text-primaryDark font-medium pt-2 text-lg">
              {type}
            </span>
            <Link
              className=" hover:underline underline-offset-2"
              ...
              href={link}
            >
              <h3 className="my-2 w-full text-left text-3xl dark:text-light font-bold">
                {title}
              </h3>{" "}
            </Link>
            ...
            <div className="flex flex-row items-center justify-between w-full">
              <Link
                className="text-dark font-bold underline-offset-2 underline dark:text-light"
                target="_blank"
                href={link}
              >
                Visit Project
  ...
  return (
    <main className="px-32 pb-16">
      <AnimatedText
        ...
        className="text-8xl dark:text-light "
      ></AnimatedText>
